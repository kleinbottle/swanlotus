...
Tesla](https://www.pbs.org/tesla/) [@tesla-pbs-bio].]]({attach}images/acmot_main02.jpg){#fig:ac-motor width=80% .modal-target}
...
![Relationship between wakefulness, dreaming and sleep.^[A simplified picture of the relationship between the states of wakefulness, sleep, and dreaming. Wakefulness and sleep are mutually exclusive. Dreaming only occurs in the sleep state.]]({attach}images/three-states.svg){#fig:three-states width=100% .modal-target}
...
been supplanted, the literary arguments are still persuasive.]]({attach}images/colour-perception-tree.svg){#fig:colour-tree width=100% .modal-target}
