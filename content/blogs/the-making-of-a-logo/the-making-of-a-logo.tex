...
\begin{figure}
\centering
\includesvg{images/trefoil.svg}
\caption{Trefoil}
\end{figure}

\begin{figure}
\centering
\includesvg{images/braid.svg}
\caption{Braid}
\end{figure}
...
{[}\citeproc{ref-mann2019}{1}--\citeproc{ref-jones2020}{3}{]}. And
whether string theory is or is not science, Popper notwithstanding, is
an issue that is still up for debate
{[}\citeproc{ref-siegel2015}{4}--\citeproc{ref-francis2019}{7}{]}.
...
\subsubsection{Kuhn and paradigm shifts}\label{kuhn-and-paradigm-shifts}
...
Structure of Scientific Revolutions}} {[}\citeproc{ref-kuhn2012}{8}{]}.
Kuhn held that science did not evolve smoothly, but every so often
experienced seismic corrections or radical changes of perspective that
led to new theories that predicted the world much better than before.
But how in heaven was he to squeeze all that into a logo? And wouldn't
that narrow it to the philosophy of science rather than to all of
philosophy? Sol rued that he had entered another
...
Descartes} {[}\citeproc{ref-watson2020}{10}{]}. He chuckled when he read
that ``the 22-year-old {[}Queen{]} Christina {[}of Sweden{]} perversely
made the 53-year-old Descartes rise before 5:00 am to give her
philosophy lessons, even though she knew of his habit of lying in bed
until 11 o'clock in the morning.'' {[}\citeproc{ref-watson2020}{10}{]}.
He read with chagrin that Descartes tragically died in Sweden from
pneumonia, presumably caused by the Scandinavian winter and the duress
of having to rise early in the morning to keep his appointment with his
royal student.
...
\subsubsection{The first cut}\label{the-first-cut}

Sol's first cut had its operative code in this fragment which I
reproduce below without explanation, simply to convey the flavour of the
process.
...
\begin{figure}
\centering
\includesvg[width=0.6\textwidth,height=\textheight]{images/firstcut.svg}
...
\begin{figure}
\centering
\includesvg[width=0.6\textwidth,height=\textheight]{images/secondcut.svg}
...
\begin{figure}
\centering
\includesvg[width=0.6\textwidth,height=\textheight]{images/thirdcut.svg}
...
\begin{figure}
\centering
\includesvg[width=0.6\textwidth,height=\textheight]{images/penultimatecut.svg}
...
\begin{figure}
\centering
\includesvg[width=0.6\textwidth,height=\textheight]{images/finalcut.svg}
...
\bibitem[\citeproctext]{ref-mann2019}
\CSLLeftMargin{{[}1{]} }%
\CSLRightInline{Adam Mann. 2019. {What Is String Theory?} Retrieved 12
November 2020 from
\url{https://www.livescience.com/65033-what-is-string-theory.html}}

\bibitem[\citeproctext]{ref-wood2019}
\CSLLeftMargin{{[}2{]} }%
\CSLRightInline{Charlie Wood. 2019. {What Is String Theory?}: Reference
...
\CSLLeftMargin{{[}3{]} }%
\CSLRightInline{Andrew Zimmerman Jones. 2019. {The Basics of String
Theory}. Retrieved 12 November 2020 from
\url{https://www.thoughtco.com/what-is-string-theory-2699363}}

\bibitem[\citeproctext]{ref-siegel2015}
\CSLLeftMargin{{[}4{]} }%
\CSLRightInline{Ethan Siegel. 2015. {Why String Theory Is Not A
Scientific Theory}. Retrieved 12 November 2020 from
\url{https://www.forbes.com/sites/startswithabang/2015/12/23/why-string-theory-is-not-science/}}

\bibitem[\citeproctext]{ref-castelvecchi2016}
\CSLLeftMargin{{[}5{]} }%
\CSLRightInline{Davide Castelvecchi. 2016. {Feuding physicists turn to
philosophy for help}: String theory is at the heart of a debate over the
integrity of the scientific method itself. Retrieved 12 November 2020
from
\url{https://www.nature.com/news/feuding-physicists-turn-to-philosophy-for-help-1.19076}}

\bibitem[\citeproctext]{ref-alves2017}
\CSLLeftMargin{{[}6{]} }%
\CSLRightInline{Rafael Alves Batista and Joel Primack. {Is String theory
falsifiable?}: Can a theory that isn't completely testable still be
useful to physics? Retrieved 12 November 2020 from
\url{https://metafact.io/factchecks/30-is-string-theory-falsifiable}}

\bibitem[\citeproctext]{ref-francis2019}
\CSLLeftMargin{{[}7{]} }%
\CSLRightInline{Matthew R Francis. 2019. {Falsifiability and physics}:
...
\bibitem[\citeproctext]{ref-kuhn2012}
\CSLLeftMargin{{[}8{]} }%
\CSLRightInline{Thomas S Kuhn. 2012. \emph{{The Structure of Scientific
Revolutions}} (50th Anniversary ed.). University of Chicago Press.}

\bibitem[\citeproctext]{ref-bardi2007}
\CSLLeftMargin{{[}9{]} }%
\CSLRightInline{Jason Socrates Bardi. 2007. \emph{{The Calculus Wars:
Newton, Leibniz, and the Greatest Mathematical Clash of All}}
(Illustrated ed.). Basic Books.}

\bibitem[\citeproctext]{ref-watson2020}
\CSLLeftMargin{{[}10{]} }%
\CSLRightInline{Richard A Watson. 2020. {René Descartes}. Retrieved 12
November 2020 from
