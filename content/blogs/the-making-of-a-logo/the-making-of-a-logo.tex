...
\CSLLeftMargin{{[}1{]} }%
\CSLRightInline{Adam Mann, {`{What Is String Theory?}'}, Mar. 20, 2019.
Available:
...
\CSLLeftMargin{{[}2{]} }%
\CSLRightInline{Charlie Wood, {`{What Is String Theory?}: Reference
article: A simplified explanation and brief history of string theory'},
Jul. 11, 2019. Available:
\url{https://www.space.com/17594-string-theory.html}. {[}Accessed: Nov.
12, 2020{]}}

\leavevmode\vadjust pre{\hypertarget{ref-jones2020}{}}%
\CSLLeftMargin{{[}3{]} }%
\CSLRightInline{Andrew Zimmerman Jones, {`{The Basics of String
Theory}'}, Mar. 02, 2019. Available:
\url{https://www.thoughtco.com/what-is-string-theory-2699363}.
{[}Accessed: Nov. 12, 2020{]}}

\leavevmode\vadjust pre{\hypertarget{ref-siegel2015}{}}%
\CSLLeftMargin{{[}4{]} }%
\CSLRightInline{Ethan Siegel, {`{Why String Theory Is Not A Scientific
Theory}'}, Dec. 23, 2015. Available:
...
\CSLLeftMargin{{[}5{]} }%
\CSLRightInline{Davide Castelvecchi, {`{Feuding physicists turn to
philosophy for help}: String theory is at the heart of a debate over the
integrity of the scientific method itself'}, Jan. 05, 2016. Available:
