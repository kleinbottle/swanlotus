...
properties are better understood from a geometric demonstration as shown
in \cref{fig:mult}.
...
\caption{The products \(4\time3\) and \(3\times4\) yield the same result
of 12. The stacking also illustrates that multiplication is repeated
addition.}\label{fig:mult}
}
\end{figure}
...
polynomial also gives us the original polynomial.
