...
\item
  ...
  numbers which are not rational, which is not entirely satisfactory. In
...
\item
  The \emph{real numbers}, as the union of the rational numbers and the
  irrational numbers, is also not entirely satisfactory, because there
  could be a third (or more) type of number that also belongs to the
  reals.\footnote{This notion was put to rest by
    \href{https://en.wikipedia.org/wiki/Richard_Dedekind}{Richard
    Dedekind} and his \emph{Schnitt} or cut, but that is \href{}{a
    story}https://ethz.ch/staffnet/en/news-and-events/internal-news/archive/2017/11/when-richard-dedekind-invented-real-numbers-at-eth-zurich.html
