...
\hypertarget{all-natural-numbers-come-out-of-zero-an-one}{%
\subsection{All natural numbers come out of zero an
one}\label{all-natural-numbers-come-out-of-zero-an-one}}

The two equations below show how we may generate any natural number from
zero, one, and the operation of addition. \[
\begin{aligned}
0 + 1 = 1
\end{aligned}
{eq:success1}
