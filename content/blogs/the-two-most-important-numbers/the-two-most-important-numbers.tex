...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.5952}}@{}}
...
\centering
\includegraphics[width=0.7\textwidth,height=\textheight]{images/xn.png}
...
&= 2.
\end{aligned}
\] The problem with the paradoxes of old was that they did not know that
infinite sums could, on occasion, be finite. And that is a problem that
mathematicians have been grappling with ever since the calculus was
invented. But that again, is a blog for another day and another
occasion.

For now, I hope that the uniqueness and ubiquity of \(0\) and \(1\) have
convinced you of their indispensability in the domain of Mathematics.
