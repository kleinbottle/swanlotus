...
back as the sum: \begin{equation}\protect\hypertarget{eq:addident}{}{
a + 0 = 0 + a = a.
...
We will consider an arbitrary \emph{square matrix}, called a
\(2 \times 2\) matrix, having four elements:
\(\begin{bmatrix} a & b\\c & d \end{bmatrix}\). Then,
