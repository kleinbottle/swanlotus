...
\begin{figure}
\centering
\includesvg[width=0.6\textwidth,height=\textheight]{images/ouroboros.svg}
\caption[Ouroboros: a snake eating its own tail.]{Ouroboros: a snake
eating its own tail.\footnotemark{}}\label{fig:ouroboros}
\end{figure}
\footnotetext{\url{https://openclipart.org/user-detail/xoxoxo}, CC0, via
  Wikimedia Commons}
...
{[}\citeproc{ref-ds-underground}{7}--\citeproc{ref-ds-yt-method}{10}{]}.
...
{[}\citeproc{ref-geogebra}{11}{]} \emojifont {😉} \normalfont.
...
\bibitem[\citeproctext]{ref-ouroboros}
\CSLLeftMargin{{[}5{]} }%
...
\bibitem[\citeproctext]{ref-strogatz-pi-day-2024}
\CSLLeftMargin{{[}15{]} }%
