...
were also in the future. We now have to backtrack and attempt to retrace
the steps Archimedes used to estimate \(\pi\) to better appreciate his
heroic efforts.
...
should get identical, closed form, expressions for both
\(\sqrt{2 - \sqrt{3}}\) and
