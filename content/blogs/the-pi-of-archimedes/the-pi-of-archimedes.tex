...
\end{aligned}
}\end{equation} The recurrence relation linking \(sin \theta_{k}\) to
\(\cos \theta_{k-1}\) has now been established.

This has been a digression because its techniques were not available to
Archimedes in his day. I have added it for completeness, and to
