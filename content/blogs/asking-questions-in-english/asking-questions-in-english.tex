...
% For English
%
\babelfont{rm}[Scale=1,BoldFont=NotoSerif-Bold]{Noto Serif Regular}
...
%% NOTE:
% the notomath packageis buggy; the Noto Sans ath font is defunct
%
% \let\arrowvert\undefined % https://tex.stackexchange.com/questions/312019/latex-error-command-circleds-already-defined-mathdesign-conflict-with-amssy
%
% \usepackage{notomath}
% \usepackage[scale=3,pf,osf]{notomath}
...
between equals, ``நீ எங்கே போகிறாய்?'' (nī eṅkē pōkiṟāi?)\footnote{Just
  for the record, the letters ``k'' in the transliteration are
  pronounced as ``g'' due to
  \href{https://en.wikipedia.org/wiki/Sandhi}{sandhi}.}. Translated into
English, these words literally become ``You where going?'' and that is
often how a newcomer to English, with a Tamil language background, will
at first speak.
