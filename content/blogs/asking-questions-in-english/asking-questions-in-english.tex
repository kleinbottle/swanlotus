...
% \usepackage[main=british]{babel}
% 
% in another header-includes file;
% in this case "$HOME/.pandoc/defaults/latex-header-includes.tex"
% 
...
% 
% Separate file xelatex-header-includes must be invoked when using xelatex as the engine.
%
