...
varuvadaṟku uṅkaḷ vīṭṭukku ippoḻudu?). This sentence replicates the
...
between equals, ``நீ எங்கே போகிறாய்?'' (nī eṅkē pōkiṟāi?)\footnote{Just for
  the record, the letters ``k'' in the transliteration are pronounced as
  ``g'' due to \href{https://en.wikipedia.org/wiki/Sandhi}{sandhi}.}.
Translated into English, these words literally become ``You where
going?'' and that is often how a newcomer to English, with a Tamil
language background, will at first speak.
...
in English. In Tamil, the more sanguine ``நீங்கள் நலமா?'' (nīṅkaḷ nalamā?)
is used, where the respectful plural form of the second person pronoun
is employed. Literally, it is a statement, posed as a question, with a
slight raise in pitch at the end to indicate the interrogative sense
when spoken. And the \emph{literal} translation into English is the
strange-sounding ``You are well?'' instead of the correct ``Are you
well?''.
...
Tamil speaker says ``உன் பெயர் என்ன?'' (un peyar enna?). In English, this
word order would be rendered as ``Your name what?'' Horror of horrors!
Where has the verb gone?
