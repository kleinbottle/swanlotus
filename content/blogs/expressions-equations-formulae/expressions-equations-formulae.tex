...
three videos to help you understand the motivation and geometric basis
for the quadratic formula, arrived at by completing the square:
...
discussed here. If the value of the expression under the square root,
\((b^2 - 4ac)\), called the
