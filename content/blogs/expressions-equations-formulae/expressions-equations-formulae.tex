...
usually taught in elementary school\footnote{I usually find it easier to
  explain concepts to students in middle school and beyond. rather than
  to elementary school students.}. Any reader who still finds it
...
output. A relation, like equality, on the other hand, establishes a
relationship---sameness in this case---between two mathematical
entities.
...
\subsubsection{Simple equations}\label{simple-equations}

\subsubsection{Quadratic equations}\label{quadratic-equations}

\subsubsection{Polynomials}\label{polynomials}

\subsubsection{Binomial theorem}\label{binomial-theorem}

\subsubsection{Trigonometric identities}\label{trigonometric-identities}
...
\subsubsection{Circumference of a
circle}\label{circumference-of-a-circle}

\subsubsection{Area of a triangle}\label{area-of-a-triangle}

\subsubsection{Volume of a cylinder}\label{volume-of-a-cylinder}
