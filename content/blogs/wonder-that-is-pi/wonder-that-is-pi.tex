...
so by professional mathematicians} {[}\citeproc{ref-niven1939}{7}{]}.
...
rather than geometric iteration, \emph{sums of successive terms} were
...
{[}\citeproc{ref-roy1990}{8},\citeproc{ref-roy2011}{9}{]}\^{}{[}It is
interesting that Madhava used the ratio of the circle arc to the radius
when denoting angles, thus establishing the naturalness of radians as
angular measure. See also {[}``A tale of two measures: degrees and
...
DOI:https://doi.org/\url{https://doi.org/10.1017/CBO9780511844195}}
