...
\subsection{The Madhava-Gregory
series}\label{the-madhava-gregory-series}

It must be obvious by now that trigonometry and the number \(\pi\) are
inextricably entwined.\footnote{If this sounds unfamiliar, I invite you
  to read my blogs
  ...
  Pi of Archimedes''}.} The quest for \(\pi\) continued to fascinate
...
For our purposes, a \emph{equence} is an \emph{ordered} procession of
...
this means in practice, let us look at the Gregory-Leibniz series.
...
rationals equal an irrational number? A transcendental number? The
