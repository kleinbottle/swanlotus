...
{[}taxonomy{]} in the zoo of numbers. It turns out that \(\pi\) is a
real number that is transcendental and therefore also irrational. Let us
pause for a while to better understand what this means.
...
we have restricted our universe to the real numbers.
...
have shown that \(5\) is algebraic by definition.
...
\item
  ...
  numbers.
\item
  The real numbers are also the union of the non-complex algebraic and
  non-complex transcendental numbers.
\item
...
\item
  The irrational numbers contain \emph{all} non-complex transcendental
  numbers and a subset of the non-complex algebraic numbers.
\end{enumerate}
