...
#
# We use Float64 for maintaining numerical precision.
#
...
function agm(an::Float64, gn::Float64)
    if (an <= 0) || (gn <= 0)
...
# Call the function with Float64 arguments

agm(sqrt(Float64(2.0)), Float64(1.0))
