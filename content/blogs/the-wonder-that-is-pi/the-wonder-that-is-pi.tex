...
discovery without the benefit of either trigonometry, decimal
(positional) notation, or calculators. He extracted square roots
...
its height. But the base equals the radius. Therefore the area of one
triangle \(A_{\Delta} = \frac{1}{2}rh\). Now six such triangles sum up
to \(\frac{1}{2}6rh\). But \(6r\) is the perimeter of the hexagon.
\emph{Therefore, the area of the hexagon is \(\frac{1}{2}Ph\) where
\(P\) is the perimeter of the hexagon}.\footnote{This statement is true
  of any \emph{inscribed polygon} as well.}
...
magnitudes of the areas. Therefore, the circumference of the circle must
lie between the perimeter of the inscribed polygon (limit from below)
and the circumscribed polygon (limit from above). This visually obvious
fact, illustrated in \cref{fig:two-limits}, is an example of ``starting
with the known.''
...
hexagon in maroon and bounded from above by the inscribed hexagon in
